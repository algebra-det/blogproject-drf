...
class PublicBlogView(APIView):
    ...
    @swagger_auto_schema(response={status.HTTP_200_OK: BlogSerializer})
...
class BlogView(APIView):
    ...
    @swagger_auto_schema(request_response={status.HTTP_200_OK: BlogSerializer})
    def get(self, request):
        try:
    ...
    @swagger_auto_schema(request_body=BlogSerializer, response={status.HTTP_200_OK: BlogSerializer})
